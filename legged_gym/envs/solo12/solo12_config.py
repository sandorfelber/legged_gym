...
class Solo12Cfg( LeggedRobotCfg ):
    ...
    class terrain( LeggedRobotCfg.terrain ):
       ...
       #  terrain types:      [smooth slope, rough slope, stairs up, stairs down, discrete, stepping stones,  gap,     trench,    pit]
        ...
        #new isaac:
        terrain_proportions = [   0.05,           0.1,      0.1,        0.1,      0.1,        0.15,         0.0,        0.4,    0.0]
    ...
    class rewards( LeggedRobotCfg.rewards ):
        ...
        class scales( ):
            ...
            lin_vel_y_in_tunnel = 0.0008 # c_vel_tunnel
            lin_vel_x_in_tunnel = 0.0008 # c_vel_tunnel
            tracking_ang_vel = 6.

            tunnel_entrance = 0.07
